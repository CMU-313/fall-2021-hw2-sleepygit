...
class DocumentReviewerHTMLWidgetTestCase(
    DocumentViewTestMixin, ReviewerTestMixin, GenericDocumentViewTestCase
):
    ...
    def test_document_reviewers_widget_no_permission(self):
    ...
    def test_document_reviewers_widget_with_document_view_access(self):
        self._create_test_reviewer(add_test_document=True)
    ...
    def test_document_reviewers_widget_with_document_reviewer_view_access(self):
        self._create_test_reviewer(add_test_document=True)
    ...
    def test_document_reviewers_widget_with_document_full_access(self):
        self._create_test_reviewer(add_test_document=True)
    ...
    def test_document_reviewers_widget_with_document_view_and_reviewer_view_access(self):
        self._create_test_reviewer(add_test_document=True)
    ...
    def test_document_reviewers_widget_with_reviewer_access(self):
        self._create_test_reviewer(add_test_document=True)
    ...
    def test_document_reviewers_widget_with_full_access(self):
        self._create_test_reviewer(add_test_document=True)
...
class DocumentSearchResultWidgetViewTestCase(
    DocumentViewTestMixin, SearchViewTestMixin, ReviewerTestMixin,
    ...
    def test_document_reviewer_widget_no_permission(self):
    ...
    def test_document_reviewer_widget_with_reviewer_type_access(self):
        self.grant_access(
            obj=self.test_reviewer, permission=permission_reviewer_view
        )
    ...
    def test_document_reviewer_widget_with_document_view_access(self):
        self.grant_access(
    ...
    def test_document_reviewer_widget_with_document_reviewer_view_access(self):
        self.grant_access(
            obj=self.test_document, permission=permission_reviewer_view
        )
    ...
    def test_document_reviewer_widget_with_all_document_access(self):
        self.grant_access(
            obj=self.test_document, permission=self._test_object_permission
        )
        self.grant_access(
    ...
    def test_document_reviewer_widget_with_reviewer_view_and_document_view_access(self):
        self.grant_access(
            obj=self.test_document, permission=self._test_object_permission
        )
        self.grant_access(
        ...
        self.assertNotContains(
            response=response, text=self.test_reviewer.label,
            status_code=200
        )

    def test_document_reviewer_widget_with_full_access(self):
        self.grant_access(
            obj=self.test_document, permission=self._test_object_permission
        )
        self.grant_access(
